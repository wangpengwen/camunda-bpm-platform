...
public interface JobDefinition {
  ...
  /**
   * The id of the deployment this job is related to. In a deployment-aware setup, this
   * leads to all jobs of the same definition being executed on the same node.
   */
